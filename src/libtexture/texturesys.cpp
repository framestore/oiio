...
std::vector<FileStatistics> TextureSystemImpl::get_file_stats() const
{
    return m_imagecache->get_file_stats();
}
...
std::vector<FileStatistics> ImageCacheImpl::get_file_stats() const
{
